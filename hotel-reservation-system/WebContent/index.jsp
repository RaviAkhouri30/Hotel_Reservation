<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
  ...
  <body>
    ...
    <footer>
      ...
      <i class="fab fa-twitter custom-ico"></i> <i class="fab fa-facebook-f custom-ico"></i> <i
        class="fab fa-instagram custom-ico"></i> <i class="fas fa-envelope-square custom-ico"></i>
